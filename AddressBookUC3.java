...
public class AddressBookUC3 {
		...
		AddressBookUC3(String firstName,String lastName,String address,String city,String state,int phoneNo,int zipNo,String emailID){
		...
		public AddressBookUC3(String firstName2, String lastName2, String address2, String city2, String state2,
			...
			public static void main(String[] args) {
				...
				do {
					...
					case 1:
						...
						c.add(new AddressBookUC3(firstName,lastName,address,city,state,phoneNo,zipNo,emailID ));
