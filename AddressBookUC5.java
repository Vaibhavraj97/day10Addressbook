...
public class AddressBookUC5 {
				...
				AddressBookUC5(String firstName,String lastName,String address,String city,String state,int phoneNo,int zipNo,String emailID){
				...
				public AddressBookUC5(String firstName2, String lastName2, String address2, String city2, String state2,
					...
					public static void main(String[] args) {
						...
						do {
							...
							case 1:
								...
								c.add(new AddressBookUC5(firstName,lastName,address,city,state,phoneNo,zipNo,emailID ));
							...
							case 3:
							 found =false;
								...
								ListIterator<AddressBookUC5>li=(ListIterator<AddressBookUC5>) c.iterator();
								while(li.hasNext()) {
									AddressBookUC5 a=li.next();
